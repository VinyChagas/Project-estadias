            ...
            <div class="container">
                <div class="row" id="estadias">
                    <div class="col-lg-4 col-md-6">
                        <div class="room-item">
                            <img src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/9d/b5/b3/estadia-hotel.jpg?w=700&h=-1&s=1" alt="">
                            <div class="ri-text">
                                <h4>Nome da estadia</h4>
                                <h3>R$ 4999<span>/Valor Pago</span></h3>
                                <table>
                                    <tbody>
                                        <tr>
                                ...
                                <P style="font-size: 10px; text-transform: uppercase;"> politica de cancelamento LOREM IPSUM DADOS DAD[ASDOASDPOMAD</P>
                                <a href="#" style="color: red;" class="primary-btn">Cancelar reserva</a><br>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="room-item">
                            ...
                            <div class="ri-text">
                                ...
                                <a href="#" class="primary-btn">Deixar opnião</a><br>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="room-item">
                            ...
                            <div class="ri-text">
                                ...
                                <a href="#" class="primary-btn">CANCELADO</a><br>
                            </div>
                        </div>
                    </div>
                </div>
